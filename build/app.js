...
const client_component_lookup = {".svelte/build/runtime/internal/start.js": "start-70f97ef5.js", "src/routes/index.svelte": "pages/index.svelte-c3c3cbf9.js"};
const manifest = {
  ...
  routes: [
    {
      ...
      css: ["assets/start-d51054ce.css", "assets/pages/index.svelte-3b6fb99c.css"],
      js: ["start-70f97ef5.js", "chunks/vendor-57a96aae.js", "pages/index.svelte-c3c3cbf9.js"]
    }
  ]
};
...
var Counter_svelte = "button.svelte-1w3ypbs{font-family:inherit;font-size:inherit;padding:1rem 2rem;--tw-text-opacity:1;color:rgba(239,68,68,var(--tw-text-opacity));--tw-bg-opacity:1;background-color:rgba(239,68,68,var(--tw-bg-opacity));--tw-bg-opacity:0.1;border-radius:9999px;--tw-border-opacity:1;outline:2px solid transparent;outline-offset:2px;width:12rem;height:60px;font-variant-numeric:tabular-nums}button.svelte-1w3ypbs:hover{border:3px solid #ff3e00}button.svelte-1w3ypbs:active{--tw-bg-opacity:1;background-color:rgba(239,68,68,var(--tw-bg-opacity));--tw-bg-opacity:0.2}";
const css$1 = {
  code: "button.svelte-1w3ypbs{font-family:inherit;font-size:inherit;padding:1rem 2rem;--tw-text-opacity:1;color:rgba(239,68,68,var(--tw-text-opacity));--tw-bg-opacity:1;background-color:rgba(239,68,68,var(--tw-bg-opacity));--tw-bg-opacity:0.1;border-radius:9999px;--tw-border-opacity:1;outline:2px solid transparent;outline-offset:2px;width:12rem;height:60px;font-variant-numeric:tabular-nums}button.svelte-1w3ypbs:hover{border:3px solid #ff3e00}button.svelte-1w3ypbs:active{--tw-bg-opacity:1;background-color:rgba(239,68,68,var(--tw-bg-opacity));--tw-bg-opacity:0.2}",
  map: '{"version":3,"file":"Counter.svelte","sources":["Counter.svelte"],"sourcesContent":["<script lang=\\"ts\\">let count = 0;\\nconst increment = () => {\\n    count += 1;\\n};\\n</script>\\n\\n<button on:click={increment}>\\n\\tClicks: {count}\\n</button>\\n\\n<style style lang=\\"postcss\\">button{font-family:inherit;font-size:inherit;padding:1rem 2rem;--tw-text-opacity:1;color:rgba(239,68,68,var(--tw-text-opacity));--tw-bg-opacity:1;background-color:rgba(239,68,68,var(--tw-bg-opacity));--tw-bg-opacity:0.1;border-radius:9999px;--tw-border-opacity:1;outline:2px solid transparent;outline-offset:2px;width:12rem;height:60px;font-variant-numeric:tabular-nums}button:hover{border:3px solid #ff3e00}button:active{--tw-bg-opacity:1;background-color:rgba(239,68,68,var(--tw-bg-opacity));--tw-bg-opacity:0.2}</style>\\n"],"names":[],"mappings":"AAU4B,qBAAM,CAAC,YAAY,OAAO,CAAC,UAAU,OAAO,CAAC,QAAQ,IAAI,CAAC,IAAI,CAAC,kBAAkB,CAAC,CAAC,MAAM,KAAK,GAAG,CAAC,EAAE,CAAC,EAAE,CAAC,IAAI,iBAAiB,CAAC,CAAC,CAAC,gBAAgB,CAAC,CAAC,iBAAiB,KAAK,GAAG,CAAC,EAAE,CAAC,EAAE,CAAC,IAAI,eAAe,CAAC,CAAC,CAAC,gBAAgB,GAAG,CAAC,cAAc,MAAM,CAAC,oBAAoB,CAAC,CAAC,QAAQ,GAAG,CAAC,KAAK,CAAC,WAAW,CAAC,eAAe,GAAG,CAAC,MAAM,KAAK,CAAC,OAAO,IAAI,CAAC,qBAAqB,YAAY,CAAC,qBAAM,MAAM,CAAC,OAAO,GAAG,CAAC,KAAK,CAAC,OAAO,CAAC,qBAAM,OAAO,CAAC,gBAAgB,CAAC,CAAC,iBAAiB,KAAK,GAAG,CAAC,EAAE,CAAC,EAAE,CAAC,IAAI,eAAe,CAAC,CAAC,CAAC,gBAAgB,GAAG,CAAC"}'
};
const Counter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let count = 0;
  $$result.css.add(css$1);
  return `<button class="${"svelte-1w3ypbs"}">Clicks: ${escape(count)}
</button>`;
});
var index_svelte = "main.svelte-51qglc{text-align:center;padding:1rem;margin-left:auto;margin-right:auto}h1.svelte-51qglc{--tw-text-opacity:1;color:rgba(220,38,38,var(--tw-text-opacity));text-transform:uppercase;font-size:3.75rem;line-height:1;font-weight:100;line-height:1.25;margin:4rem auto}h1.svelte-51qglc,p.svelte-51qglc{max-width:20rem}p.svelte-51qglc{margin:2rem auto;line-height:1.375}@media(min-width:640px){h1.svelte-51qglc,p.svelte-51qglc{max-width:none}}";
const css = {
...
const Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main class="${"svelte-51qglc"}"><h1 class="${"svelte-51qglc"}">Hello world!</h1>
	...
	<p class="${"svelte-51qglc"}">Visit <a class="${"text-blue-600 underline"}" href="${"https://svelte.dev"}">svelte.dev</a> to learn how to build Svelte apps.</p>
</main>`;
});
...
var global = "/*! tailwindcss v2.0.4 | MIT License | https://tailwindcss.com*/\n/*! modern-normalize v1.0.0 | MIT License | https://github.com/sindresorhus/modern-normalize */:root{-moz-tab-size:4;-o-tab-size:4;tab-size:4}html{line-height:1.15;-webkit-text-size-adjust:100%}body{margin:0;font-family:system-ui,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji}hr{height:0;color:inherit}abbr[title]{-webkit-text-decoration:underline dotted;text-decoration:underline dotted}b,strong{font-weight:bolder}code,kbd,pre,samp{font-family:ui-monospace,SFMono-Regular,Consolas,Liberation Mono,Menlo,monospace;font-size:1em}small{font-size:80%}sub,sup{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sub{bottom:-.25em}sup{top:-.5em}table{text-indent:0;border-color:inherit}button,input,optgroup,select,textarea{font-family:inherit;font-size:100%;line-height:1.15;margin:0}button,select{text-transform:none}[type=button],[type=reset],[type=submit],button{-webkit-appearance:button}::-moz-focus-inner{border-style:none;padding:0}:-moz-focusring{outline:1px dotted ButtonText}:-moz-ui-invalid{box-shadow:none}legend{padding:0}progress{vertical-align:baseline}::-webkit-inner-spin-button,::-webkit-outer-spin-button{height:auto}[type=search]{-webkit-appearance:textfield;outline-offset:-2px}::-webkit-search-decoration{-webkit-appearance:none}::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}summary{display:list-item}blockquote,dd,dl,figure,h1,h2,h3,h4,h5,h6,hr,p,pre{margin:0}button{background-color:transparent;background-image:none}button:focus{outline:1px dotted;outline:5px auto -webkit-focus-ring-color}fieldset,ol,ul{margin:0;padding:0}ol,ul{list-style:none}html{font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;line-height:1.5}body{font-family:inherit;line-height:inherit}*,:after,:before{box-sizing:border-box;border:0 solid #e5e7eb}hr{border-top-width:1px}img{border-style:solid}textarea{resize:vertical}input::-moz-placeholder, textarea::-moz-placeholder{opacity:1;color:#9ca3af}input:-ms-input-placeholder, textarea:-ms-input-placeholder{opacity:1;color:#9ca3af}input::placeholder,textarea::placeholder{opacity:1;color:#9ca3af}[role=button],button{cursor:pointer}table{border-collapse:collapse}h1,h2,h3,h4,h5,h6{font-size:inherit;font-weight:inherit}a{color:inherit;text-decoration:inherit}button,input,optgroup,select,textarea{padding:0;line-height:inherit;color:inherit}code,kbd,pre,samp{font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,Liberation Mono,Courier New,monospace}audio,canvas,embed,iframe,img,object,svg,video{display:block;vertical-align:middle}img,video{max-width:100%;height:auto}*{--tw-shadow:0 0 transparent;--tw-ring-inset:var(--tw-empty,/*!*/ /*!*/);--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgba(59,130,246,0.5);--tw-ring-offset-shadow:0 0 transparent;--tw-ring-shadow:0 0 transparent}.mx-auto{margin-left:auto;margin-right:auto}.my-16{margin-top:4rem;margin-bottom:4rem}.my-8{margin-top:2rem;margin-bottom:2rem}.w-48{width:12rem}.max-w-xs{max-width:20rem}.max-w-none{max-width:none}.rounded-full{border-radius:9999px}.border{border-width:1px}.border-opacity-100{--tw-border-opacity:1}.bg-red-500{--tw-bg-opacity:1;background-color:rgba(239,68,68,var(--tw-bg-opacity))}.bg-opacity-10{--tw-bg-opacity:0.1}.bg-opacity-20{--tw-bg-opacity:0.2}.p-4{padding:1rem}.py-4{padding-top:1rem;padding-bottom:1rem}.px-8{padding-left:2rem;padding-right:2rem}.text-center{text-align:center}.text-6xl{font-size:3.75rem;line-height:1}.font-thin{font-weight:100}.uppercase{text-transform:uppercase}.diagonal-fractions,.lining-nums,.oldstyle-nums,.ordinal,.proportional-nums,.slashed-zero,.stacked-fractions,.tabular-nums{--tw-ordinal:var(--tw-empty,/*!*/ /*!*/);--tw-slashed-zero:var(--tw-empty,/*!*/ /*!*/);--tw-numeric-figure:var(--tw-empty,/*!*/ /*!*/);--tw-numeric-spacing:var(--tw-empty,/*!*/ /*!*/);--tw-numeric-fraction:var(--tw-empty,/*!*/ /*!*/);font-variant-numeric:var(--tw-ordinal) var(--tw-slashed-zero) var(--tw-numeric-figure) var(--tw-numeric-spacing) var(--tw-numeric-fraction)}.tabular-nums{--tw-numeric-spacing:tabular-nums}.leading-tight{line-height:1.25}.leading-snug{line-height:1.375}.text-red-500{--tw-text-opacity:1;color:rgba(239,68,68,var(--tw-text-opacity))}.text-blue-600{--tw-text-opacity:1;color:rgba(37,99,235,var(--tw-text-opacity))}.text-red-600{--tw-text-opacity:1;color:rgba(220,38,38,var(--tw-text-opacity))}.underline{text-decoration:underline}.outline-none{outline:2px solid transparent;outline-offset:2px}";
